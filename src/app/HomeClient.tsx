"use client" // <--- Biarkan ini di atas
...
// Impor statis LatestPostsSection dihapus dari sini
...
// 2. BUAT 'LatestPostsSection' di-load secara dinamis
// Ini adalah kunci perbaikannya
const LatestPostsSection = dynamic(
  () => import('@/sections/LatestPostsSection'),
  { 
    ssr: false, // <-- Memberitahu Next.js untuk TIDAK render ini di server
    // Opsional: tampilkan placeholder loading
    loading: () => <section className="container h-96"></section> 
  }
)

// ... (kode 'variants' 'pageEnterVariant' dll biarkan sama) ...
...
// 3. HAPUS prop 'latestPosts' dari fungsi ini
export default function HomeClient() { // <-- prop 'latestPosts' dihapus
  const [showScrollTop, setShowScrollTop] = useState(false)
  const [contentReady, setContentReady] = useState(false)

  // ... (semua kode useEffect, scrollToTop, dll biarkan sama) ...
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background text-foreground">
      ...
      {/* ... (semua kode background effects, navbar, dll biarkan sama) ... */}
...
      <Navbar />
      ...
      >
        ...
        {/* 4. RENDER 'LatestPostsSection' LANGSUNG DI SINI */}
        <LatestPostsSection />
      ...
      {/* ... (semua kode footer & scroll to top biarkan sama) ... */}
      <motion.footer 
